...
""",
    ...
    def test_from_file_docx_extracts_section_column_layouts(self) -> None:
        ...
        self.assertEqual(parsed.paragraphs[0].para_style.column_count, 1)
        self.assertEqual(parsed.paragraphs[1].para_style.column_count, 3)
        self.assertAlmostEqual(parsed.paragraphs[1].para_style.column_gap_pt or 0.0, 36.0, places=2)
...
""",
        ...
        self.assertEqual([paragraph.para_style.column_count for paragraph in parsed.paragraphs], [1, 3, 3])
        self.assertAlmostEqual(parsed.paragraphs[1].para_style.column_gap_pt or 0.0, 3.0, places=2)
